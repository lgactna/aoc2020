...
def parser(input):
    positions, target_char, password = input.split(" ")
    positions = positions.split("-")
    position_1 = int(positions[0])-1
    position_2 = int(positions[1])-1
    target_char = target_char[0]
    
    chars_in_password = 0

    if password[position_1] == target_char:
        chars_in_password += 1
    if password[position_2] == target_char:
        chars_in_password += 1
        
    if chars_in_password == 1:
        return True
    else:
        return False
